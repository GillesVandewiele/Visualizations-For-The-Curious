...
execute("extract_attribute.py --in Verkeerstijden.json --out time_list_unclean.json --attr_name Time")
execute("create_correcting_time_dictionary.py --in time_list_unclean.json --out time_list.json --dict time_corrector.json")
execute("sort_list.py --in time_list.json --out time_list_sorted.json")
execute("create_enumeration_dictionary.py --in time_list_sorted.json --out time_dict.json")
execute("swap_enumeration_dictionary.py --in time_dict.json --out times.json")
subprocess.call("gzip times.json -9", shell=True)
execute("update_attribute.py --to_update Verkeerstijden.json --updated Verkeerstijden_short.json --dict route_names_corrector.json --attr_name Route")
...
execute("update_attribute.py --to_update Verkeerstijden_short.json --updated Verkeerstijden_short.json --dict time_corrector.json --attr_name Time")
execute("update_attribute.py --to_update Verkeerstijden_short.json --updated Verkeerstijden_short.json --dict time_dict.json --attr_name Time")
execute("sort_data.py --in Verkeerstijden_short.json --out Verkeerstijden_short.json --attr_name Time")
