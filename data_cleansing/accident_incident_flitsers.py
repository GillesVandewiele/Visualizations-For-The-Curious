...
execute("extract_attribute.py --in aifw.json --out time_list_unclean.json --attr_name Time")
...
execute("update_attribute.py --to_update aifw.json --updated aifw_short.json --dict time_corrector.json --attr_name Time")
execute("update_attribute.py --to_update aifw_short.json --updated aifw_short.json --dict time_dict.json --attr_name Time")
execute("sort_data.py --in aifw_short.json --out aifw_short.json --attr_name Time")
