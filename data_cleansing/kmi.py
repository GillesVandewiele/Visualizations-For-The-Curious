...
execute("extract_attribute.py --in kmihourly.json --out time_list_unclean.json --attr_name Time")
...
execute("update_attribute.py --to_update kmihourly_short.json --updated kmihourly_short.json --dict time_corrector.json --attr_name Time")
...
execute("sort_data.py --in kmihourly_short.json --out kmihourly_short.json --attr_name Time")
